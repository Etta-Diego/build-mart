...
const PurchaseSuccessPage = () => {
	...
	useEffect(() => {
		const handleCheckoutSuccess = async (sessionId) => {
			try {
				await orderApi.post("../payments/checkout-success", {
					sessionId,
				});
				clearCart();
			} catch (error) {
	...
	return (
		<div className='h-screen flex items-center justify-center px-4'>
			...
			<div className='max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden relative z-10'>
				<div className='p-6 sm:p-8'>
					...
					<div className='space-y-4'>
						<button
							className='w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4
